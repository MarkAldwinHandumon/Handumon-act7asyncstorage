  ...
  const addStudent = async () => {
    ...
    try {
      if (firstName !== '' && lastName !== '' && course !== '' && username !== '' && password !== '') {
        ...
        toast.show("Data Successfully Added", {
          type: "success",
          placement: "bottom",
          duration: 4000,
          offset: 30,
...
function StudentLists({ navigation }) {
  ...
  return (
    <View style={{ backgroundColor: 'white' }}>
      ...
      <View style={{ marginBottom: 30 }}>
        <Button title="Delete Data" onPress={handleDeleteData} color="maroon" />
      </View>
    </View>
  );
}
...
function AddStudentPage() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Home" component={DashView} />
